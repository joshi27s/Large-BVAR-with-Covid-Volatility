...
scenario_name = 'increase1Y_unrestricted'
...
idxCV = Spec.index[Spec['SeriesID'] == 'GS1'].tolist()[0]  # 1-Year Treasury Yield
Shock = np.nan * np.ones((h_fore.sum(), n))  # h_fore is a boolean array indicating forecasts
Shock[0, idxCV] = 0.75  # 75 bps increase in 1-Year Treasury Yield
