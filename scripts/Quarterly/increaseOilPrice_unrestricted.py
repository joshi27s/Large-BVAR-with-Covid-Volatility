...
scenario_name = 'increaseOilPrice_unrestricted'
...
idxCV = Spec.index[Spec['SeriesID'] == 'OILPRICEx'].tolist()[0]  # 1-Year Treasury Yield
...
Shock[0, idxCV] = 10  # Set macro variables to unconditional forecast (0 shock)
