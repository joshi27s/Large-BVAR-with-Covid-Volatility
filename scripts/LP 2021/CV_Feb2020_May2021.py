...
T1av = data.index[(data['DATE'].dt.year == 2021) & (data['DATE'].dt.month == 5)][0]       # date of last available data for forecasting
...
with open(f'{results}/CVFeb2020_{comparison_vintage_date}.pkl', 'wb') as f:
